...
import Creational.AbstractFactory.Example2.PizzaIngredientFactory.BangalorePizzaIngredientFactory;
...
public class BangalorePizzaStore extends PizzaStore {
    ...
    public Pizza createPizza(String item) {
        ...
        PizzaIngredientFactory ingredientFactory = new BangalorePizzaIngredientFactory();

        if (item.equals("cheese")) {
            //Creates a instance of Pizza that is composed with the Bangalore Ingredient Factory.
            ...
            pizza.setName("Bangalore Style Clam Pizza");
